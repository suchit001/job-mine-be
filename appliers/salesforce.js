...
exports.salesforceAutoApply = async (url) => {
    ...
    try {
        ...
        await howDidYouHearInput.sendKeys('Salesforce Careers Website');
        ...
        const preferedLocation = await driver.findElement(By.id("primaryQuestionnaire--d603833528ba10107950ebc042a80000"));
        preferedLocation.clear();
        await preferedLocation.sendKeys('Any');
        
        const q1 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107950ebc042a80001'));
        ...
        const q2 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107950ecf393e00000'));
        ...
        const q3 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107950ee26ca340000'));
        ...
        const q4 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107950eec07dc30001'));
        ...
        const q5 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107950f12722ec0000'));
        ...
        const q6 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107950f25a44500000'));
        await driver.executeScript("arguments[0].scrollIntoView({ behavior: 'smooth', block: 'center' });", q6);
        await driver.sleep(1000);
        await q6.click();
        await q6.sendKeys("No");
        await q6.sendKeys(Key.ENTER);

        const q7 = await driver.findElement(By.id('primaryQuestionnaire--d603833528ba10107951182691d50000'));
